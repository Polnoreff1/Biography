...
struct Data {
    var pictures: [[String]] = [["Qscreen1","Qscreen2","Qscreen3"],["screen1","screen2","screen3"]]
    var descriptions: [String] = ["""
        ...
        Приложение писалось на архитектуре MVC.
        Отдельное и большое спасибо Александру, Илье и Кнкуш, которые помогали на пути обучения и познания Swift
"""
    ...
    var namesOfProjects: [String] = ["Try to fry", "Quizlet"]
    var picturesOfProjects: [String] = ["avatarOfTry", "avatarOfQuizlet"]
}
